...
import { SECTIONS, STORAGE_KEY, loadChecks, saveChecks, itemId } from '../data/systemDesignData'
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div className="prep-header">
        <h1>🏗️ System Design for AI/ML</h1>
        <p>ML SYSTEM DESIGN · RAG · LLM SERVING · AGENTS · MLOPS · INTERVIEW PATTERNS</p>
      </div>
